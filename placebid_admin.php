  ...
  <button class="btn btn-inverse" type="submit"><img src="images/find.png" alt="find"></button>
   ...
   <table class="table table-striped table-hover">
	 ...
	 <?php
		 ...
		 $dnr = mysql_query("Select * from donnorinfo where `index` = '".$arrclient['index']."'");
		 $dnr_cnt = mysql_num_rows($dnr);
	 ...
	 ?> 
	 	<tr>
		  <td><a href="itemlist_admin.php?id=<?php echo $arrclient['index']; ?>"><?php echo $arrclient['Phone']; ?></a></td>
		  <td><?php echo $arrclient['FirstName']. " " . $arrclient['LastName']; ?></td>
		  <td><?php echo $arrclient['TownName']; ?></td>
		  <td><input type="checkbox" name="donor" id="donor" class="donor" value="<?php echo $arrclient['index']; ?>" <?php echo $slct; ?> > </td>
	 ...
	 <?php endwhile; ?>	
		...
		<ul>
		<?php echo $o__pager->getPagerString('placebid_admin.php'.$qurey_string); ?>
		</ul>
	</div>
