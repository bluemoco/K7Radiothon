...
$(document).ready(function(){  
	 ...
	 jQuery('#btn33').removeClass('btn-inverse');	
	 jQuery('#btn33').addClass('btn-primary');     
});
</script>
...
<body>
   ...
   <div class="container">   
   <div class="subheads">Placing a Challenges </div>
   ...
   <table class="table table-striped table-hover">
	 ...
	 ?> 
	 	<tr>
		  ...
		  <td><a href="challenge_list.php?id=<?php echo $arrclient['index']; ?>" ><img src="images/edit.png" ></a></td>
		</tr>
	 <?php endwhile; ?>	
		...
		<ul>
		<?php echo $o__pager->getPagerString('challenge_bid.php'.$qurey_string); ?>
		</ul>
	</div>
