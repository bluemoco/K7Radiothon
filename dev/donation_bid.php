...
<body>
   ...
   <div class="container">   
   <div class="subheads">Placing a Donation </div>
   ...
   <table class="table table-striped table-hover">
	 ...
	 ?> 
	 	<tr>
		  ...
		  <td><a href="pledge_list.php?id=<?php echo $arrclient['index']; ?>" ><img src="images/edit.png" ></a></td>		   
		</tr>
	 <?php endwhile; ?>	
		...
		<ul>
		<?php echo $o__pager->getPagerString('donation_bid.php'.$qurey_string); ?>
		</ul>
	</div>
