...
<?php
// bids
$q = "SELECT * FROM `bids` WHERE `ReceiptInfo` = " . $id;
...
while ($clientBidDetails = mysql_fetch_array($clientBids)) {
    ?>
                                <tr> 
                                    <td><a href="#"><?php echo $clientBidDetails['AucID']; ?></a></td>
...
?>
        <tr>
           <td><a href="#"><?php echo $clientpledgesDetails['ChallengeID'];?></a></td>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                                ...
                                while ($clientDonationDetails = mysql_fetch_array($clientDonations)) {
                                   ?>
                             <tr >
                                <td><?php echo $clientDonationDetails['PledgeID'];?></td>
