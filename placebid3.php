...
<body>
  ...
  <button class="btn btn-inverse" type="button"><img src="images/find.png" alt="find"></button>
   ...
   <div class="span4">
      <div class="row-fluid">
        <div class="span10">
    <div class="text-center"> <h2>BIDDING FOR:</h2>

   <img src="images/biltong.jpg" class="thumbnail">
  
   <h3 class="text-info">Kidu Bilton</h3>
   </div>
   </div>
</div>
  ...
  <div class="span4 left-right-border">
   
    <div class="text-center"> 
 <div class="span3">
  <img src="images/trophy.png" alt="tr">
  </div>
   <div class="span9">
   <h2>HIGHEST BIDDERS:</h2>
   
   <h3 class="text-info">Jhon Honay</h3>
   <h3 class="text-info">N$ 299.9</h3>
  </div>
   </div>
     <div class="clearfix"></div> 
    <hr>
 ...
 <img src="images/glass.jpg" alt="glass">
   ...
   <div class="row-fluid">
 <div class="span3">
<img src="images/Hourglass.png" alt="h">
  </div>
  ...
  <div class="bar bar-danger" style="width: 40%;"></div>
   ...
   <h3 class="text-info">3 Days 32H 30M 60S</h3>
  </div>
  ...
  <div class="clearfix"></div>
  <button type="submit" class="btn btn-warning">Save</button> <button type="submit" class="btn">Reset</button>
   </div>
